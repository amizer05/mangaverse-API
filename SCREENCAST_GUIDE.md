# 🎬 Screencast Opname Guide - MangaVerse API

## 📋 Doel
Demonstreer je Node.js API project in **één take** en verdien maximaal punten.

## ⏱️ Totale Duur: 8-12 minuten

---

## 🎯 STAP-VOOR-STAP SCREENCAST SCRIPT
...
```bash
# In Postman/Thunder Client of terminal
...
```bash
# Maak meerdere mangas aan voor demo
POST /mangas
- "One Piece"
- "Dragon Ball"
- "Bleach"
...
### Post-Productie:
- **Trim** onnodige wachttijden
- **Voeg titels toe** (optioneel)
- **Export** als MP4 (H.264)
- **Upload** naar YouTube/Vimeo of lever in als bestand
...
- [ ] Test user aangemaakt (admin@test.com)
- [ ] JWT token werkt
- [ ] Alle CRUD operaties getest
- [ ] Validatie errors werken
- [ ] Paginatie werkt
- [ ] Zoeken werkt
- [ ] Sorteren werkt
- [ ] Relaties werken
...
- [ ] README compleet
- [ ] Microfoon getest
- [ ] Scherm resolutie goed
- [ ] OBS/recording software klaar
